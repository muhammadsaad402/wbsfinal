...
export default function ReviewedOrderCard() {
  ...
  const getOrders = () => {
    const artistdata = isClient
      ? reactLocalStorage && reactLocalStorage.getObject("isArtist")
      : null;
    ...
    axios
      ...
      .then((response) => {
        setOrders(response.data.data.review_orders);
