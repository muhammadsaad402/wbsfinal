...
const cardData = [
  {
    id: "1",
    status: "Aprove",
    name: "Zuhaib Ahmad Rana Chandio",
    orderNo: "23000008",
    price: "5000",
    date: "Mar,08,2023",
  },
  {
    id: "2",
    status: "Aprove",
    name: "Zuhaib Ahmad Rana Chandio1",
    orderNo: "23000008",
    price: "5000",
    date: "Mar,08,2023",
  },
...
export default function RecievedAllOrderCard({ orders: propOrders }) {
  ...
  const getOrders = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        // console.log(response.data.data.pending_orders, "order");
  ...
  useEffect(() => {
    if (propOrders.data?.pending_orders) {
      setOrders(propOrders.data.pending_orders);
      setOrdersLoader(true);
    } else {
      getOrders();
    }
